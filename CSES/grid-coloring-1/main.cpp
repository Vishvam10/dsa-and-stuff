...
void solve() {
	...
	=> Order must be preserved. We start from top left and go down row by row.
	In that way, we make sure that at any point, only the top and the left
	element is chosen always :
