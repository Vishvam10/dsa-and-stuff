...
void solve() {
	...
	/*
	  ...
	  So, here we don't care about the "a chooses from 1..n, b chooses
	  from 1..m" approach at all. All we care about it "how many turns did a win
	  and how many turns did b win"
